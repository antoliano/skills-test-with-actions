...
1. Click the **New ruleset** and select **New branch ruleset**. Use the following settings:
   ...
   <img width="300" alt="target branch settings" src="https://raw.githubusercontent.com/antoliano/skills-test-with-actions/main/.github/images/branch-protection-target-settings.png" />

   <img width="300" alt="required status checks" src="https://raw.githubusercontent.com/antoliano/skills-test-with-actions/main/.github/images/required-status-checks.png" />
...
1. Scroll to the bottom to find failed workflows and the **Merge** button now disabled! Nice! 🥰
   ...
   <img width="500" alt="failed tests and disabled merge button" src="https://raw.githubusercontent.com/antoliano/skills-test-with-actions/main/.github/images/failed-tests-disabled-merge.png" />
...
1. Click the **Merge** button.
   ...
   <img width="500" alt="image" src="https://raw.githubusercontent.com/antoliano/skills-test-with-actions/main/.github/images/merge-button-active.png" />
